...
class ManageCitiesDialog(QtWidgets.QDialog):
    ...
    def _build(self):
        ...
        for n in self.NATIONS_AVAILABLE:
    ...
    def _load_city_to_form(self, ckey: str):
        ...
        try:
            ...
            self.lbl_warehouse_capacity.setText(f"{wl * self.WAREHOUSE_TONS} t")
    ...
    def _on_warehouse_changed(self, value: int):
        ...
        self.lbl_warehouse_capacity.setText(f"{value * self.WAREHOUSE_TONS} t")
